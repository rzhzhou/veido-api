...
class AdministrativePenalties(models.Model):
    ...
    case_name = models.CharField(
        max_length=255, null=True, blank=True, verbose_name=u'案件名称')
    illegal_behavior = models.CharField(
        max_length=255, null=True, blank=True, verbose_name=u'违法行为')
    punishment_basis = models.CharField(
