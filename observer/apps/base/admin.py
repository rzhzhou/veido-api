...
#     related_search_fields = {'area': ('name',)}
#     fields = ('title', 'abstract', 'source', 'area',
#               'keywords', 'score', 'pubtime')
...
#     def save_model(self, request, obj, form, change):
#         obj.keywords = jieba.analyse.extract_tags(
#             obj.title, topK=3, withWeight=True, allowPOS=())
#         if not change:
...
#                 return
#             if old_keyword != obj.title:
#                 CrawlerTask(obj.title, "zjld",
#                             u"风险快讯").update_task(old_keyword)
#             obj.save()
