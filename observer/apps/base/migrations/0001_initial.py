    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(verbose_name='\u4e0a\u4e00\u7ea7', blank=True, to='base.Area', null=True)),
            ],
            options={
                'db_table': 'area',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(verbose_name='\u6587\u7ae0', to='base.Article')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_query_name=b'category', related_name='categorys', to='base.Article', blank=True, null=True, verbose_name='\u6587\u7ae0')),
            ],
            options={
                'db_table': 'category',
        ...
        migrations.CreateModel(
            name='CategoryAtricle',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('article', models.ForeignKey(to='base.Article')),
                ('category', models.ForeignKey(to='base.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_query_name=b'custom', related_name='customs', to='base.Article', blank=True, null=True, verbose_name='\u6587\u7ae0')),
            ],
            options={
                'db_table': 'custom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom', models.ForeignKey(default='', blank=True, to='base.Custom', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(verbose_name='\u5206\u7ec4', to='base.Group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_query_name=b'product', related_name='products', to='base.Article', blank=True, null=True, verbose_name='\u6587\u7ae0')),
            ],
            options={
                'db_table': 'product',
        ...
        migrations.CreateModel(
            name='RelatedDataAtricle',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('article', models.ForeignKey(to='base.Article')),
                ('relateddata', models.ForeignKey(to='base.RelatedData')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_query_name=b'collection', related_name='collections', to='base.Article', through='base.ArticleCollection', blank=True, null=True, verbose_name='\u6587\u7ae0')),
            ],
            options={
                'db_table': 'collection',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(max_length=255, verbose_name='\u4fe1\u606f\u6765\u6e90')),
                ('status', models.IntegerField(default=3, verbose_name='\u540d\u79f0')),
                ('create_at', models.DateTimeField(verbose_name='\u521b\u5efa\u65f6\u95f4')),
                ('update_at', models.DateTimeField(verbose_name='\u66f4\u65b0\u65f6\u95f4')),
                ('create_id', models.CharField(max_length=255, null=True, verbose_name='\u521b\u5efa\u4eba', blank=True)),
                ('province', models.CharField(max_length=255, verbose_name='\u7701')),
                ('city', models.CharField(max_length=255, null=True, verbose_name='\u5e02', blank=True)),
                ('district', models.CharField(max_length=255, null=True, verbose_name='\u5730\u533a', blank=True)),
                ('sync', models.IntegerField(null=True, verbose_name='\u540c\u6b65\u72b6\u6001', blank=True)),
            ],
            options={
                'db_table': 'inspection',
                'verbose_name_plural': '\u62bd\u68c0',
