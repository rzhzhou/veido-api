...
from observer.apps.riskmonitor.models import RiskInspectionPublisher, RiskInspection, \
                                            Industry, Enterprise


class RiskInspectionResources(resources.ModelResource):
    ...
    publisher = fields.Field(
        column_name=u'文章发布者',
        attribute='publisher',
        widget=ForeignKeyWidget(RiskInspectionPublisher, 'name'))
    area = fields.Field(
        column_name=u'地域',
        attribute='area',
