...
urlpatterns = [
    ...
    url(r'^risknews_recycle$', RiskNewsRecycleList.as_view()),
    url(r'^risknews/update$', RiskNewsUpdate.as_view()),
    url(r'^risknews/delete$', RiskNewsDelete.as_view()),
