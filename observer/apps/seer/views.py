...
from observer.apps.base.models import Inspection, Area, Enterprise, Industry
from observer.apps.seer.models import ( Cache, AreaIndustry, UserArea)
            ...
            'indicators': [
                {
                    ...
                    'norms': [
                        {
                            'name': u'国家强制性要求',
                            'value':u'有' if queryset['indicators'][0][0][0] == 1 else u'无',
                            'options': [
                        ...
                        {
                            'name': u'密切程度',
                            'value':u'低' if queryset['indicators'][0][0][1] == 1 else (u'中' if queryset['indicators'][0][0][1] == 2 else u'高'),
                            'options': [
                        ...
                        {
                            'name': u'涉及特定消费群体',
                            'value':u'是' if queryset['indicators'][0][0][2] == 1 else u'否',
                            'options': [
                ...
                },
                {
                    ...
                    'norms': [
                        {
                            'name': u'贸易量',
                            'value':u'低' if queryset['indicators'][1][0][0] == 1 else (u'中' if queryset['indicators'][1][0][0] == 2 else u'高'),
                            'options': [
                                {'label': u'高', 'selected': queryset[
                                    'indicators'][1][0][0] == 3},
                                {'label': u'中', 'selected': queryset[
                ...
                },
                {
                    ...
                    'norms': [
                        {
                            'name': u'列入许可证目录',
                            'value': u'是' if queryset['indicators'][2][0][0] == 1 else u'否',
                            'options': [
                                {'label': u'是', 'selected': queryset[
                                    'indicators'][2][0][0] == 1},
                                {'label': u'否', 'selected': queryset[
                        ...
                        {
                            'name': u'列入产品认证目录',
                            'value':u'是' if queryset['indicators'][2][0][1] == 1 else u'否',
                            'options': [
                                {'label': u'是', 'selected': queryset[
                                    'indicators'][2][0][1] == 1},
                                {'label': u'否', 'selected': queryset[
                        ...
                        {
                            'name': u'是否鼓励',
                            'value':u'是' if queryset['indicators'][2][0][2] == 1 else u'否',
                            'options': [
                                {'label': u'是', 'selected': queryset[
                                    'indicators'][2][0][2] == 1},
                                {'label': u'否', 'selected': queryset[
                        ...
                        {
                            'name': u'是否限制',
                            'value':u'是' if queryset['indicators'][2][0][3] == 1 else u'否',
                            'options': [
                                {'label': u'是', 'selected': queryset[
                                    'indicators'][2][0][3] == 1},
                                {'label': u'否', 'selected': queryset[
                        ...
                        {
                            'name': u'是否淘汰',
                            'value':u'是' if queryset['indicators'][2][0][4] == 1 else u'否',
                            'options': [
                                {'label': u'是', 'selected': queryset[
                                    'indicators'][2][0][4] == 1},
                                {'label': u'否', 'selected': queryset[
