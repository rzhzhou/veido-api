...
urlpatterns = [
    ...
    url(r'^validnews$', ValidNews.as_view()),
    url(r'^risknews_valid$', RiskNewsValid.as_view()),
    ...
    url(r'^productupdate$', ProductUpdate.as_view()),
]
