    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_name='categorys', related_query_name='category', to='yqj.Article', verbose_name='\u6587\u7ae0')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_name='customs', related_query_name='custom', to='yqj.Article', verbose_name='\u6587\u7ae0')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ManyToManyField(related_name='relateddatas', related_query_name='relateddata', to='yqj.Article', verbose_name='\u6587\u7ae0')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='origin.Area', verbose_name='\u5730\u57df')),
                ('articles', models.ManyToManyField(related_name='risks', related_query_name='risk', to='yqj.Article', verbose_name='\u6587\u7ae0')),
            ],
            options={
                'ordering': ['-pubtime'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pubtime', models.DateTimeField(blank=True, null=True, verbose_name='\u53d1\u5e03\u65f6\u95f4')),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='origin.Area', verbose_name='\u5730\u57df')),
                ('articles', models.ManyToManyField(related_name='topics', related_query_name='topic', to='yqj.Article', verbose_name='\u6587\u7ae0')),
            ],
            options={
                'ordering': ['-pubtime'],
        ...
        migrations.AddField(
            model_name='topic',
            name='weibo',
            field=models.ManyToManyField(related_name='topics', related_query_name='topic', to='yqj.Weibo', verbose_name='\u5fae\u535a'),
        ),
        migrations.AddField(
            model_name='topic',
            name='weixin',
            field=models.ManyToManyField(related_name='topics', related_query_name='topic', to='yqj.Weixin', verbose_name='\u5fae\u4fe1'),
        ),
        migrations.AddField(
            model_name='risk',
            name='weibo',
            field=models.ManyToManyField(related_name='risks', related_query_name='risk', to='yqj.Weibo', verbose_name='\u5fae\u535a'),
        ),
        migrations.AddField(
            model_name='risk',
            name='weixin',
            field=models.ManyToManyField(related_name='risks', related_query_name='risk', to='yqj.Weixin', verbose_name='\u5fae\u4fe1'),
        ),
        migrations.AddField(
            model_name='relateddata',
            name='weibo',
            field=models.ManyToManyField(related_name='relateddatas', related_query_name='relateddata', to='yqj.Weibo', verbose_name='\u5fae\u535a'),
        ),
        migrations.AddField(
            model_name='relateddata',
            name='weixin',
            field=models.ManyToManyField(related_name='relateddatas', related_query_name='relateddata', to='yqj.Weixin', verbose_name='\u5fae\u4fe1'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='custom',
            name='weibo',
            field=models.ManyToManyField(related_name='customs', related_query_name='custom', to='yqj.Weibo', verbose_name='\u5fae\u535a'),
        ),
        migrations.AddField(
            model_name='custom',
            name='weixin',
            field=models.ManyToManyField(related_name='customs', related_query_name='custom', to='yqj.Weixin', verbose_name='\u5fae\u4fe1'),
        ),
        migrations.AddField(
            model_name='article',
            name='publisher',
        ...
        migrations.AddField(
            ...
            name='articles',
            field=models.ManyToManyField(related_name='collections', related_query_name='collection', through='yqj.ArticleCollection', to='yqj.Article', verbose_name='\u6587\u7ae0'),
        ),
        migrations.AddField(
            model_name='collection',
            name='events',
            field=models.ManyToManyField(related_name='collections', related_query_name='collection', through='yqj.TopicCollection', to='yqj.Topic', verbose_name='\u8d28\u91cf\u4e8b\u4ef6'),
        ),
        migrations.AddField(
