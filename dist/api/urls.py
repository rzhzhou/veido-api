...
urlpatterns = patterns('',
    ...
    url(r'^category/(?P<id>\d+)/(?P<page>\d+)/$', ArticleTableView.as_view()),
    ...
    url(r'^location/(?P<location_id>\d+)/(?P<page>\d+)/$', LocationTableView.as_view()),
    url(r'^news/(?P<page>\d+)/$', NewsTableView.as_view()),
    url(r'^collection/$', CollectView.as_view()),
    url(r'^event/(?P<page>\d+)/$', EventTableView.as_view()),
    url(r'^event/(?P<id>\d+)/(?P<page>\d+)/$', EventDetailTableView.as_view()),
    ...
    url(r'^custom/(?P<custom_id>\d+)/$', CustomTableView.as_view()),
