...
class CustomView(BaseTemplateView):
    ...
    def get(self, request):
        ...
        return self.render_to_response('custom/list.html', {'custom_list': keyword_list, 'keyword_list': newkeyword_list})
...
class CustomDetailView(BaseTemplateView):
    ...
    def get(self, request, id):
        ...
        try:
            ...
            return self.render_to_response('custom/detail.html', {'name': u''})
        return self.render_to_response('custom/detail.html', {'name': custom.newkeyword})
